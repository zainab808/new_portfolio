                ...
                size.width < 1206
                    ? Wrap(
                        ...
                        children: [
                          ...
                          SizedBox(width: 20), // ✅ instead of Spacer()
                          Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                       ...
                       AlertText(
                              ...
                              // contact info sections unchanged
                              if (size.width > 235)
                                Row(
                                  children: [
                              AlertText(
                              ...
                              if (size.width > 235) SizedBox(height: 10),
                              if (size.width > 235)
                                Row(
                                  children: [
                                 AlertText(
                    ...
                    : Row(
                        children: [
                          Container(
                            height: size.width < 1115 ? 300 : 400,
                            width: size.width < 1116 ? 300 : 400,
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage("flower/doll.png"),
                              ),
