...
//     return TextField(
//       cursorColor: const Color(0xff7E19AF),
//       decoration: InputDecoration(
//         prefixIcon: Icon(icon, color: const Color(0xff7E19AF), size: 25),
//         focusedBorder: const OutlineInputBorder(
//           borderSide: BorderSide(color: Color(0xff7E19AF), width: 2),
//         ),
//         border: const OutlineInputBorder(),
//         hintText: hint,
//         hintStyle: const TextStyle(color: Colors.black),
//         filled: true,
//         fillColor: const Color(0xffE5ECFB),
//       ),
//     );
//   }
...
//       cursorColor: const Color(0xff7E19AF),
//       decoration: InputDecoration(
//         prefixIcon: const Icon(Icons.message, color: Color(0xff7E19AF)),
//         hintText: "Message",
//         hintStyle: const TextStyle(color: Colors.black),
//         filled: true,
//         fillColor: const Color(0xffE5ECFB),
...
//         ),
//         focusedBorder: OutlineInputBorder(
//           borderSide: const BorderSide(color: Color(0xff7E19AF), width: 2),
//           borderRadius: BorderRadius.circular(10),
//         ),
//       ),
//     );
